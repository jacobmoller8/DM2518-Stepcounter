    ...
    return (
      <View style={styles.flexView}>
        ...
        <TouchableOpacity
          ...
          onPress={() => this.props.navigation.navigate("PicturePickerScreen")}
        >
          <Icon name="edit" color={"#455C97"} size={35} />
        </TouchableOpacity>

        <Text style={styles.nameLabel}>{this.props.user.name}</Text>
        <Text style={styles.emailLabel}>{this.props.user.email}</Text>
          ...
          <TouchableOpacity style={styles.sponsorBackground}>
            ...
            >
              <Image
                ...
                source={{
                  uri:
                    "https://pbs.twimg.com/profile_images/972080657542406144/F-zbVzrm.jpg"
                }}
              />
              <View
                style={{
